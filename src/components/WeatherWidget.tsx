...
const WeatherWidgetComponent = ({
  ...
  return (
    <button
      ...
      className="br-press w-[min(68vw,240px)] rounded-2xl border border-white/16 bg-black/40 px-3 py-2 text-left text-slate-100 shadow-[0_10px_30px_rgba(0,0,0,0.42)] backdrop-blur-md transition hover:border-white/28 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/25"
    >
